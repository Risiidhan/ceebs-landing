    ...
    <body className="p-4 md:p-8 lg:p-12">
      <div className="max-w-4xl mx-auto bg-[#181818] shadow-lg rounded-lg p-6 md:p-8 lg:p-10">
        ...
        <section className="mb-10">
          <h2
            className="text-2xl-responsive md:text-3xl font-bold mb-4"
            id="agreement-to-our-legal-terms"
          >
            AGREEMENT TO OUR LEGAL TERMS
          </h2>
          <p className="mb-4">
            We are KPTAC Technologies, doing business as KPTAC (&quot;Company,&quot; &quot;we,&quot;
            &quot;us,&quot; &quot;our&quot;), a company registered in the United Arab Emirates at
            Dubai. We operate the mobile application CEEBS (the &quot;App&quot;), as well
            as any other related products and services that refer or link to
            these legal terms (the &quot;Legal Terms&quot;) (collectively, the
            &quot;Services&quot;).
          </p>
          <p className="mb-4">
            CEEBS is a unique social media platform built to nurture authentic,
            human-to-human connections, distinguishing itself with a commitment
            to anonymity as a starting point. This encourages users to express
            themselves freely without identity pressure. The platform features
            modular experiences including Moments, Connect, Wall, Broadcast, and
            Whisper, allowing content sharing, interest-based discussions, and
            gradual relationship building. Functioning like a human diary, CEEBS
            initially encourages users to share everything except their faces or
            identifiable traits, with trust building leading to deeper personal
            connections.
          </p>
          <p className="mb-4">
            The Moments module acts as a reflective journal. Broadcast enables
            users within proximity to organize and participate in shared
            interest activities. Whisper introduces time-bound private chats for
            authentic discovery. Connect uses a Health-Wealth-Happiness matrix
            to match users based on compatibility. Wall serves as a space for
            open, anonymous debates on social and global issues. CEEBS offers a
            seamless and evolving user journey with features like age and
            location-based feed personalization, compatibility-based matching,
            and cross-module integrations. It is a platform designed for people
            to be heard, understood, and truly seen, starting from the inside
            out.
          </p>
          <p className="mb-4">
            You can contact us by email at{" "}
            <a
              href="mailto:info@ceebs.com"
              className="text-blue-600 hover:text-blue-800"
            >
              info@ceebs.com
            </a>{" "}
            or by mail to Dubai, United Arab Emirates. These Legal Terms
            constitute a legally binding agreement between you and KPTAC
            Technologies, concerning your access to and use of the Services. By
            ...
            Services you are using. Modified Legal Terms become effective upon
            posting or notification via{" "}
            <a
              href="mailto:info@ceebs.com"
              className="text-blue-600 hover:text-blue-800"
            >
            ...
            , as stated in the email. Your continued use of the Services after
            the effective date of any changes signifies your agreement to be
            bound by the modified terms.
          </p>
          <p className="mb-4">
            The Services are intended for users who are at least 13 years of
            age. All users who are minors in their jurisdiction (generally under
            18) must have permission from and be directly supervised by their
            parent or guardian to use the Services. If you are a minor, your
            parent or guardian must read and agree to these Legal Terms before
            you use the Services. We recommend you print a copy of these Legal
            Terms for your records.
          </p>
        </section>

        <section className="mb-10 p-6 bg-[#0e0e0ea5] rounded-lg shadow-inner">
          <h2 className="text-xl-responsive md:text-2xl font-bold mb-4">
            Table of Contents
          </h2>
        ...
        <section id="our-services" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
            1. OUR SERVICES
          </h3>
          <p className="mb-4">
            ...
            requirement within such jurisdiction or country. Persons who access
            the Services from other locations do so on their own initiative and
          ...
          <p className="mb-4">
            ...
            Management Act (FISMA). Therefore, if your interactions would be
            subjected to such laws, you may not use the Services. You may also
            not use the Services in a way that would violate the
            Gramm-Leach-Bliley Act (GLBA).
          </p>
        </section>

        <section id="intellectual-property-rights" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
            2. INTELLECTUAL PROPERTY RIGHTS
          </h3>
          <div className="mb-6">
            <h4 className="text-lg-responsive md:text-xl font-semibold mb-2">
            ...
            <p className="mb-4">
              ...
              photographs, and graphics (collectively, the &quot;Content&quot;), as well
              as trademarks, service marks, and logos (the &quot;Marks&quot;). Our Content
              and Marks are protected by copyright and trademark laws and
              treaties in the United States and worldwide.
            </p>
            <p className="mb-4">
              The Content and Marks are provided through the Services &quot;AS IS&quot;
          ...
          <div className="mb-6">
            ...
            <p className="mb-4">
              ...
              section, we grant you a non-exclusive, non-transferable, revocable
              license to:
            </p>
            ...
            <p className="mb-4">
              Except as stated in this section or elsewhere in our Legal Terms,
            ...
            <p className="mb-4">
              ...
              . If we grant you permission to post, reproduce, or publicly
              display any part of our Services or Content, you must identify us
              as the owners or licensors and ensure that any copyright or
              proprietary notice appears or is visible.
            </p>
            <p className="mb-4">
          ...
          <div className="mb-6">
            ...
            <p className="mb-4">
              ...
              <strong className="font-bold">&quot;PROHIBITED ACTIVITIES&quot;</strong>{" "}
              section carefully to understand (a) the rights you give us and (b)
              your obligations when you post or upload content through the
              Services.
            </p>
            <p className="mb-4">
              <strong className="font-bold">Submissions:</strong> By directly
            ...
            <p className="mb-4">
              <strong className="font-bold">Contributions:</strong> The Services
              may invite you to chat, contribute to, or participate in blogs,
              message boards, online forums, and other functionality where you
              may create, submit, post, display, transmit, publish, distribute,
            ...
            <p className="mb-4">
              ...
              of the Services. When you post Contributions, you grant us an
          ...
          <div className="mb-6">
            ...
            <p className="mb-4">
              ...
              <strong className="font-bold">&quot;COPYRIGHT INFRINGEMENTS&quot;</strong>{" "}
              section below.
            </p>
          </div>
        </section>

        <section id="user-representations" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
          ...
          <ul className="list-disc ml-6 mb-4">
            ...
            <li>
              You are not a minor in your jurisdiction, or if a minor, you have
        ...
        <section id="user-registration" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
            4. USER REGISTRATION
          </h3>
          <p className="mb-4">
        ...
        <section id="user-generated-contributions" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
          ...
          <p className="mb-4">
            When you create or make available any Contributions, you hereby
        ...
        <section id="contribution-license" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="mobile-application-license" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
          ...
          <div className="mb-6">
            ...
            <ul className="list-disc ml-6 mb-4">
              ...
              <li>
                Use the App for creating a product, service, or software that
        ...
        <section id="services-management" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="privacy-policy" className="mb-10">
          ...
          <p className="mb-4">
            ...
            that differ from applicable laws in the United Arab Emirates, then
            through your continued use of the Services, you are transferring
            your data to the United Arab Emirates, and you expressly consent to
            have your data transferred to and processed in the United Arab
            Emirates.
          </p>
          <p className="mb-4">
        ...
        <section id="copyright-infringements" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="term-and-termination" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="modifications-and-interruptions" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="governing-law" className="mb-10">
          ...
          <p className="mb-4">
            ...
            laws of the United Arab Emirates. KPTAC Technologies and yourself
        ...
        <section id="dispute-resolution" className="mb-10">
          ...
          <p className="mb-4">
            ...
            the jurisdiction of the United Arab Emirates courts. KPTAC
            Technologies shall also maintain the right to bring proceedings as
            to the substance of the matter in the courts of the country where
        ...
        <section id="limitations-of-liability" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="user-data" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
            21. USER DATA
          </h3>
          <p className="mb-4">
        ...
        <section id="electronic-communications" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
        ...
        <section id="sms-text-messaging" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
          ...
          <div className="mb-6">
            ...
            <p className="mb-4">
              By opting into any CEEBS text messaging program, you expressly
              consent to receive text messages (SMS) to your mobile number.
              CEEBS text messages may include: order updates.
            </p>
          </div>
          <div className="mb-6">
            <h4 className="text-lg-responsive md:text-xl font-semibold mb-2">
        ...
        <section id="california-users" className="mb-10">
          <h3 className="text-xl-responsive md:text-2xl font-bold mb-4">
